...
import com.thalgrim.warhammer.repository.UtilisateurRepository;
...
/**
 * REST controller for managing {@link com.thalgrim.warhammer.domain.Utilisateur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class UtilisateurResource {
    ...
    private static final String ENTITY_NAME = "warhammerJhipsterUtilisateur";
