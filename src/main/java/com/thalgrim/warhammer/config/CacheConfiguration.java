package com.thalgrim.warhammer.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("WarhammerJhipster");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("WarhammerJhipster");
        ...
        config.getMapConfigs().put("com.thalgrim.warhammer.domain.*", initializeDomainMapConfig(jHipsterProperties));
